...
<h1 class=" text-center pt-2 pb-2" id="title">A2B Restaurant</h1>
</div>`;
...
<p id="description" class="text-center text-white">This below User Table hold the user entered information only</p>`;
...
<thead>
  <tr>
    ...
    <th scope="col" style="text-align: center;">Ordered Food</th>
